...
class _reflect_ClassRegistry
{
  static std::unordered_map<
      std::string /*类名*/,
      std::shared_ptr<reflect_Obj> (*)(ConstructorArgTypes...) /*任意参数构造函数*/> &
  getMap_make_shared()
  {
  ...
  static std::unordered_map<
      std::string /*类名*/,
      reflect_Obj *(*)(ConstructorArgTypes...) /*任意参数构造函数*/> &
  getMap_new()
  {
    static std::unordered_map<
        std::string /*类名*/,
...
public:
  ...
  static void set(
      std::string const &className,
      std::shared_ptr<reflect_Obj> (*_func)(ConstructorArgTypes...))
  {
